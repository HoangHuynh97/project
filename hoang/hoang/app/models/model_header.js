...
define(["require", "exports", "../../assets/js/global"], function (require, exports, global) {
    ...
    return /** @class */ (function () {
        function model_header() {
        }
        model_header.prototype.uploadSong = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    console.log(data);
                    return [2 /*return*/, fetch("".concat(global.api_url, "upload_song"), {
                            method: 'POST',
                            body: data
        ...
        model_header.prototype.searchSong = function (key_search) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch("".concat(global.api_url, "search_song"), {
                            method: 'POST',
                            headers: {
...
//# sourceMappingURL=model_header.js.map