...
define(["require", "exports", "../../assets/js/global"], function (require, exports, global) {
    ...
    return /** @class */ (function () {
        ...
        model_login.prototype.checkLogin = function (inputUser, inputPw) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch("".concat(global.api_url, "api_login"), {
                            method: 'POST',
                            headers: {
        ...
        model_login.prototype.getSignUP = function (inputUser, inputPw, inputName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch("".concat(global.api_url, "api_signup"), {
                            method: 'POST',
                            headers: {
                                'Accept': 'application/json, text/plain, */*',
                                'Content-Type': 'application/json'
...
//# sourceMappingURL=model_login.js.map