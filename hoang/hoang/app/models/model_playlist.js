...
define(["require", "exports", "../../assets/js/global"], function (require, exports, global) {
    ...
    return /** @class */ (function () {
        function model_playlist() {
        }
        model_playlist.prototype.getDataSong = function (id_playlist, id_user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch("".concat(global.api_url, "get_Playlist"), {
                            method: 'POST',
                            headers: {
...
//# sourceMappingURL=model_playlist.js.map